...
# Ablation: ResNet50 + FGE trained on LL-ONLY (no WL images).
# Purpose: prove mixed LL+WL training > LL-only on same backbone as ITM.
# ITM: ResNet50, LL-only, 210ep → LL-A=41.7
# Expected here: ~41-43 LL-A (40ep, same paradigm as ITM)
# Mixed result:  ResNet50+FGE mixed 40ep → LL-A=48.5  (+6-7 AP = C1 proof)
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='Annotations/ExLPose_train_LL.json',
...
work_dir = 'work_dirs/tdhm_res50_exlpose_fge_ll_only'
