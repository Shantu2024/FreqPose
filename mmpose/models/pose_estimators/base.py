...
class BasePoseEstimator(BaseModel, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        if lowlight_module is not None:
            self.lowlight_module = MODELS.build(lowlight_module)
    ...
    @property
    def with_lowlight_module(self) -> bool:
        """bool: whether the pose estimator has a low-light module."""
        return hasattr(self, 'lowlight_module') and \
            self.lowlight_module is not None
    ...
    def extract_feat(self, inputs: Tensor) -> Tuple[Tensor]:
        ...
        Returns:
            ...
            resolutions.
        """
        if self.with_lowlight_module:
            inputs = self.lowlight_module(inputs)
